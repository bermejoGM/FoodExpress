...
public class AppConfig {
    ...
    /*
        ...
        WebClient es parte del módulo Spring WebFlux y se usa para hacer peticiones HTTP de forma reactiva y no bloqueante, aunque también se puede usar en aplicaciones no reactivas.
